...
int main(int argc, const char** argv)
{
    ...
    using cvra::motor::config::EnableMotor;
    uavcan::ServiceClient<EnableMotor> client(node);
    ...
    client.setCallback([](const uavcan::ServiceCallResult<EnableMotor>& call_result)
        {
