...
def move(x):
    ...
    right_wheel_msg.position = right_wheel_pos + external_to_internal_wheelbase_encoder_direction *right_wheel_direction * x / right_wheel_radius
    ...
    left_wheel_msg.position = left_wheel_pos + external_to_internal_wheelbase_encoder_direction *left_wheel_direction * x / left_wheel_radius
